...
class ServerThread extends Thread {
	...
	SecmemService secmem = null;
	UsableModeService usableMode = null;
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            try {
		Slog.i(TAG,  "Secmem Service");
		secmem = new SecmemService(context);
		ServiceManager.addService(Context.SECMEM_SERVICE, secmem);
            } catch (Throwable e) {
		Slog.e(TAG, "Failure starting Secmem Service", e);
            }

            try {
		Slog.i(TAG,  "Usable Mode Service");
		usableMode = new UsableModeService(context);
		ServiceManager.addService(Context.USABLE_MODE_SERVICE, usableMode);
            } catch (Throwable e) {
		Slog.e(TAG, "Failure starting Usable Mode Service", e);
            }
