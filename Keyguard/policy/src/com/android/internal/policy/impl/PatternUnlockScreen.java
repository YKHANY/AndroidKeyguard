...
class PatternUnlockScreen extends LinearLayoutWithDefaultTouchRecepient
    ...
    PatternUnlockScreen(Context context,
        ...
        if (mCreationOrientation != Configuration.ORIENTATION_LANDSCAPE) {
            ...
            visibleScreen =  inflater.inflate(R.layout.keyguard_screen_unlock_portrait, this, true);
        } else {
            Log.d(TAG, "landscape mode");
            visibleScreen = inflater.inflate(R.layout.keyguard_screen_unlock_landscape, this, true);
        }
        ...
        mLockPatternView.setVisibility(INVISIBLE);
		 	
	       final TextView info = (TextView)findViewById(R.id.Pattern_info);
...
//					 findViewById(R.id.lockPattern).setVisibility(View.VISIBLE);
//					 mLockPatternView.setOnPatternListener(new UnlockPatternListener());
//					 LockPatternKeyguardView.SecureMode = true;
//				}
//			});
        }
...
//        }else{
//        	visibleScreen.findViewById(R.id.lockPattern).setVisibility(VISIBLE);
//        }
        if(KeyguardViewMediator.SECUREMODE == 3){
        	visibleScreen.findViewById(R.id.lockPattern).setVisibility(VISIBLE);
        	mLockPatternView.setOnPatternListener(new UnlockPatternListener());
        	TextView info = (TextView)findViewById(R.id.Pattern_info);
        	info.setVisibility(View.INVISIBLE);
