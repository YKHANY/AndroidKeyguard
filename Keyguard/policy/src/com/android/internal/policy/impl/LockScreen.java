...
class LockScreen extends LinearLayout implements KeyguardScreen {
	...
	LockScreen(Context context, Configuration configuration, LockPatternUtils lockPatternUtils,
		...
		if (mCreationOrientation != Configuration.ORIENTATION_LANDSCAPE) {
			visibleScreen = inflater.inflate(R.layout.keyguard_screen_tab_unlock, this, true);
		} else {
			visibleScreen = inflater.inflate(R.layout.keyguard_screen_tab_unlock_land, this, true);
		}
		...
		if(KeyguardViewMediator.SECUREMODE != 3){
			Log.d(TAG,"SecureMode : no");
			visibleScreen.findViewById(R.id.unlock_widget).setVisibility(INVISIBLE);

			final TextView info = (TextView)findViewById(R.id.Lockscreen_info);
			...
			//        info.setTextSize(15);
			//        info.setId(R.id.lockscreen_info);
	...
	public void onResume() {
		...
		//            
		//        }else{
		//        	visibleScreen.findViewById(R.id.unlock_widget).setVisibility(VISIBLE);
		//        }
		if(KeyguardViewMediator.SECUREMODE == 3){
			Log.d(TAG,"resume SecureMode : yes");
			visibleScreen.findViewById(R.id.unlock_widget).setVisibility(VISIBLE);
			TextView info = (TextView)findViewById(R.id.Lockscreen_info);
